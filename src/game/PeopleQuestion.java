...
public class PeopleQuestion extends ArrayList<Question> {
    // Constructor
    public PeopleQuestion(String question, ArrayList<String> answers) {
        add(new Question(question, answers));
    }
    public static PeopleQuestion definePeopleQuestions() {
        PeopleQuestion peopleQuestions = new PeopleQuestion("", new ArrayList<>());
